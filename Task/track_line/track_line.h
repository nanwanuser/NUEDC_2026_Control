...
#define TRACK_LINE_BASE_SPEED 200.0f
#endif

#ifndef TRACK_LINE_SLIGHT_INNER_SPEED
#define TRACK_LINE_SLIGHT_INNER_SPEED 148.0f
#endif

#ifndef TRACK_LINE_SLIGHT_OUTER_SPEED
#define TRACK_LINE_SLIGHT_OUTER_SPEED 228.0f
#endif

#ifndef TRACK_LINE_NORMAL_INNER_SPEED
#define TRACK_LINE_NORMAL_INNER_SPEED 68.0f
#endif

#ifndef TRACK_LINE_NORMAL_OUTER_SPEED
#define TRACK_LINE_NORMAL_OUTER_SPEED 234.0f
#endif

#ifndef TRACK_LINE_SHARP_INNER_SPEED
#define TRACK_LINE_SHARP_INNER_SPEED 0.0f
#endif

#ifndef TRACK_LINE_SHARP_OUTER_SPEED
#define TRACK_LINE_SHARP_OUTER_SPEED 250.0f
#endif
...
// 丢线后按最后方向单侧轮搜索，超过该时间后自然停止。
#ifndef TRACK_LINE_LOST_SEARCH_SPEED
#define TRACK_LINE_LOST_SEARCH_SPEED 200.0f
#endif
